...
import { MahjongChallenge } from '../challenges/mahjong-challenge/mahjong-challenge';
  ...
  private loadChallengeComponent(): void {
    ...
    switch (this.dayConfig.challengeType) {
      ...
      case 'mazeRunner':
        ...
        break;
      case 'presentStacking':
        componentType = PresentStackingChallenge;
        break;
      case 'giftCatcher':
      ...
      case 'skiSlope':
        ...
        break;
      case 'mahjong':
        componentType = MahjongChallenge;
        break;
      default:
